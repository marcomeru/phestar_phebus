...
def phestar_check_param(whatto, kernel, timest, timend, timestep, scanp, maxang) :
    ...
    scanp : (integer) For the star search, this is ignored. For the visualizer, 
        this is the chosen scanner position. It can range from 115 to 3980.
            ...
            if rets == 2 : 
                ...
                try :
                    ...
                    try :
                        ...
                        sg.PopupError("The scanner position must be a positive integer between 115 and 3980!")
                        return(1)
                    else :
                        if tmp < 115 or tmp > 3980 :
                            sg.PopupError("The scanner position must be a positive integer between 115 and 3980!")
                            return(1)
                        else :
